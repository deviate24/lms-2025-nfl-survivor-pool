"""
Django settings for lms2025 project.
"""
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'deviate.pythonanywhere.com', 'lms2025.xyz', 'www.lms2025.xyz']
...
WSGI_APPLICATION = 'lms2025.wsgi.application'
...
# Set timezone to America/Los_Angeles for 4PM PT deadlines
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'LMS 2025 <noreply@example.com>')
